...
<template>
  <div class="worklist">
      <div class="light wide-tall">   
        <a href="/images/eekwi.org-old.jpeg" target="_blank">          
          <img src="/images/eekwi.org-old.jpeg" style="object-fit: contain;">
        </a>           
        <div class="content">
          <h2>EEK Wisconsin</h2>
        ...
        <a href="/images/www.eekwi.org.jpeg" target="_blank">          
          <img src="/images/www.eekwi.org.jpeg" style="object-fit: contain;">
        </a>  
      </div>
      <div class="dark wide-tall">
        <a href="/images/www.tomahhealth.org-old.jpeg" target="_blank">          
          <img src="/images/www.tomahhealth.org-old.jpeg" style="object-fit: contain;">
        </a>  
        <div class="content">
          <h2>Tomah Health</h2>
        ...
        <a href="/images/www.tomahhealth.org.jpeg" target="_blank">          
          <img src="/images/www.tomahhealth.org.jpeg" style="object-fit: contain;">
        </a>
      </div>
      <div class="light wide-tall">
        <a href="/images/neurology.wisc.edu-old.jpeg" target="_blank">          
          <img src="/images/neurology.wisc.edu-old.jpeg" style="object-fit: contain;">
        </a>
        <div class="content">
        ...
        <a href="/images/neurology.wisc.edu.jpeg" target="_blank">          
          <img src="/images/neurology.wisc.edu.jpeg" style="object-fit: contain;">
        </a>        
      </div>
      <div class="dark wide-tall">        
        <img src="/images/tripweather.jpeg">
        <div class="content">
          <h2>Trip Weather</h2>
          <p>Trip Weather is a personal project written in pure HTML and Javascript that allows someone to check weather conditions along a specific route between two points. I created it from scratch, since I was always checking the weather while traveling, and wanted an easier way to determine what the weather would be along my route, at the time that I would be passing through specific points. The site uses a logarithmic method to determine which points along the route to check the weather for, then queries the National Weather Service to determine the conditions at that point and time.</p>
          <a href="https://tripweather.co" target="_blank">Trip Weather</a>
        </div>        
      </div>
  </div> 
</template>
